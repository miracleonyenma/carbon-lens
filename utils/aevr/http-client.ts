...
export class HttpClient {
  ...
  async request<T>(
    ...
    return this.executeWithRetries(async () => {
      ...
      const requestOptions: RequestInit = {
        ...
        credentials: options.credentials || "include", // Include cookies for cross-origin requests
      };
  ...
  private parseError(
    ...
    // Handle OAuth/OpenID Connect standard error format
    if (
      typeof data === "object" &&
      data !== null &&
      "error" in data &&
